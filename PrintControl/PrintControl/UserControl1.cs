...
namespace PrintControl
{
    ...
    public class PrinterControl : IObjectSafety
    {
        ...
        public string SilentPrint(string Url, string PostData, string cookieStr, string printerParams, string charset, PrinterSettings settings)
        {
            ...
            return "{status:'success',msg:'打印成功'}";
        }
